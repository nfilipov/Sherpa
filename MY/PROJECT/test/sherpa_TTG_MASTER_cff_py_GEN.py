...
# with command line options: MY/PROJECT/python/sherpa_TTG_MASTER_cff.py -s GEN -n 10000 --no_exec --conditions auto:mc --eventcontent RAWSIM
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MY/PROJECT/python/sherpa_TTG_MASTER_cff.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/eos/user/n/nfilipov/zg_sherpa/sherpa_TTG_MASTER_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("SherpaGeneratorFilter",
    ...
    SherpackChecksum = cms.string('f81e5bd9750794b7917768a038412dbd'),
