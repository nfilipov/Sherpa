...
# with command line options: MY/PROJECT/python/sherpa_MMG_MASTER_cff.py -s GEN -n 100 --no_exec --conditions auto:mc --eventcontent RAWSIM
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MY/PROJECT/python/sherpa_MMG_MASTER_cff.py nevts:100'),
...
process.generator = cms.EDFilter("SherpaGeneratorFilter",
    ...
    SherpackChecksum = cms.string('118a0b84ac88e2c86bfee46f8957561a'),
