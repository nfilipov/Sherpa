...
# with command line options: MY/PROJECT/python/sherpa_TTG_MASTER_cff.py -s GEN -n 100 --no_exec --conditions auto:mc --eventcontent RAWSIM
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MY/PROJECT/python/sherpa_TTG_MASTER_cff.py nevts:100'),
