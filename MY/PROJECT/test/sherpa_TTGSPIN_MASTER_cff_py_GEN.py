...
# with command line options: MY/PROJECT/python/sherpa_TTGSPIN_MASTER_cff.py -s GEN -n 10000 --no_exec --conditions auto:mc --eventcontent RAWSIM
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MY/PROJECT/python/sherpa_TTGSPIN_MASTER_cff.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('sherpa_TTGSPIN_MASTER_cff_py_GEN.root'),
